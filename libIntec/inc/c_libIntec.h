...
extern "C"
{
	int __libIntec_Initialize(IntecUsbDeviceType dev)
	{
		return libIntec_Initialize(dev);
	}
...
//	int __libIntec_ReadDeviceByAddr(unsigned int index, unsigned int addr, unsigned char *szBuffer, unsigned int *cbRead);
//	int __libIntec_WriteDeviceByAddr(unsigned int index, unsigned int addr, unsigned char *szBuffer, unsigned int cbRead);
