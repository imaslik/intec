...
class CIntecUSBDeviceH: public CIntecUSBDevice
{

public : 

	CIntecUSBDeviceH(IntecUsbDeviceType devType, DWORD devIndex,IntecDeviceOperationMode mode,IntecDeviceDriverType driverType);
